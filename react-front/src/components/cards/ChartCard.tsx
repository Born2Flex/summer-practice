        ...
        <div className="flex flex-col gap-y-6 w-11/12 p-8 self-center bg-gray-100/70 my-6 rounded-lg">
            ...
            <div className='flex w-full'>
                ...
                <div className='w-1/3 p-6'>
                    ...
                    <p>GoEventFlow has experienced significant growth in recent years, driven by several key factors:</p>
            ...
            <div className='flex w-full'>
                <div className='w-1/2 p-6'>
                    <h2 className="text-5xl font-bold mb-6">GoEventFlow whole year round!</h2>
