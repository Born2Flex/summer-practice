    ...
    return (
        ...
        <div className="flex items-center justify-center aspect-square">
            <label
                ...
                className={`flex flex-col items-center justify-center w-full border-2 ${preview ? 'border-gray-800' : 'border-gray-300 border-dashed'} rounded-lg cursor-pointer bg-gray-100 hover:bg-blue-gray-50`}
            >
                {!preview && (<div className="flex flex-col h-5/6 aspect-square items-center justify-center pt-5 pb-6">
